...
//простое Swing-приложение, которое обеспечивает
...
public class AStarApp {
    ...
    private Location startLoc;      //точка начала
    private Location finishLoc;     //точка финиша

    private JMapCell[][] mapCells;      //Это 2D-массив компонентов пользовательского интерфейса, которые обеспечивают отображение ячеек на карте и манипулирование ими.
